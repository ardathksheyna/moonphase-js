export function DataTableSun() {
    return (
        <ul className="data-table sun-data js-sun-data">
            ...
            <li><strong className="label">Civil Twilight Starts</strong><span data-name="civil_twilight_begin"
                                                                              className="value"></span></li>
            <li><strong className="label">Civil Twilight Ends</strong><span data-name="civil_twilight_end"
                                                                            className="value"></span></li>
